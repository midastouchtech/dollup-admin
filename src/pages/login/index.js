  ...
  return (
    <Container id="appElement">
        <Wrapper>
            ...
            <br/>
            <br/>
            <LinkA onClick={()=>navigate("/register")}> <Button>Register</Button> </LinkA>
            <br/>
            <br/>
            <Error>{error && error}</Error>
            <Error>{loading === true && <p><PropagateLoader color={color} loading={loading} css={override} size={15} /></p>}</Error>
